...
import { companyListInput, companyListOutput, companyIdInput, companyDetailOutput, companyOptionsInput, companyOptionOutput, companyCreateInput, companySummaryOutput, mapsImportInput, mapsImportResult, companyUpdateArgs, companyArchiveResultOutput, companyBulkOwnerInput, companyBulkResultOutput, companyBulkInput, companyEnrichOutput, companyResearchOutput, setPrimaryContactInput, companySetPrimaryContactOutput } from "../companies/companies.contracts";
...
const appRouter = t.router({
  ...
  companies: t.router({
    ...
    create: publicProcedure
      ...
      .mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    importFromMaps: publicProcedure
