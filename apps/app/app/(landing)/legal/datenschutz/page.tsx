...
export default function DatenschutzPage() {
	return (
		<article className="prose prose-invert max-w-none">
			...
			<p>
				[Anbieter-Details, Adresse, Datenschutzhinweise des Anbieters eintragen]
			</p>
			...
			<p>
				[Details zu verwendeten Analyse-Tools eintragen, z.B. Google Analytics,
				Matomo, etc.]
			</p>
			...
			<p>
				[Details zu verwendeten externen Diensten eintragen, z.B. Google Fonts,
				Maps, etc.]
			</p>
